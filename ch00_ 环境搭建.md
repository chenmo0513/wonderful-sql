...
找到刚才下载好的msi文件, 双击开始安装. ❗️❗️❗️**强烈建议初学者采用完全安装模式( Full )进行安装**（缺点是不能修改安装目录）:
...
## 2.0 使用命令行方式连接MySQL服务（推荐指数 ⭐️ ⭐️ ⭐️）
...
## 2.1 [选学]使用 MySQL Workbench 连接 MySQL（推荐指数 ⭐️）
...
## 2.2 [选学]使用 HeidiSQL 连接 MySQL（推荐指数 ⭐️ ⭐️ ⭐️）
...
## 2.3 [选学]使用 DBeaver 连接 MySQL（推荐指数 ⭐️ ⭐️ ⭐️）
...
## 2.4 [选学]使用 Navicat 连接 MySQL（推荐指数 ⭐️ ⭐️ ⭐️ ⭐️ ⭐️）
...
提取码：vktl
![图片](./img/ch00/ch00595.png)


![图片](./img/ch00/ch00596.png)

![图片](./img/ch00/ch00597.png)

## 2.5 [选学]使用 SQLyog 连接 MySQL（推荐指数 ⭐️ ⭐️ ⭐️ ⭐️）
...
## 2.6 [选学]DataGrip的安装和连接MySQL（推荐指数 ⭐️ ⭐️ ⭐️ ⭐️）
